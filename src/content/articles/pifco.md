...
featured: false
faqs:
  - q: "Is the Pifco tower fan any good?"
    a: "For very small rooms or desk use it is adequate. Airflow is limited and it lacks features like a remote or timer, but for a compact fan at around 30 pounds it provides basic cooling in a small space without any fuss. Do not expect it to cool a full living room."
  - q: "How tall is the Pifco tower fan?"
    a: "At around 70 cm it is shorter than a full-size tower fan, which is intentional. The compact height makes it suitable for placing on a desk or shelf, though it also means the airflow is directed at a lower point than standard tower fans when placed on the floor."
  - q: "Does the Pifco tower fan oscillate?"
    a: "Yes, it has around 45 degrees of oscillation. This is the narrowest in the budget category and better suited to cooling one person at a desk than spreading airflow around a room. For personal cooling it is sufficient, for room coverage it is limited."
  - q: "What is the Pifco tower fan best used for?"
    a: "Desk or worktop use, or as a secondary fan for a very small bedroom. Its compact size and light weight make it easy to position close to where you are sitting, which is the most effective way to use a fan with limited throw."
relatedSlugs:
