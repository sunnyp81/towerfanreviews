...
faqs:
  ...
  - q: "What heating modes should I look for?"
    a: "Look for at least two heat settings (low and high), a thermostat you can set to a target temperature, and a timer. Oscillation is useful on a heater as it distributes warm air more evenly. A cool-air-only mode means you get a usable fan in summer without needing a separate appliance."
relatedSlugs:
  - best-tower-fans
...
For running cost comparisons with other heating options, see our [tower fan running cost guide](/tower-fan-running-cost/). If you are prioritising noise above all else, the [best quiet tower fans](/best-quiet-tower-fans/) page is a better starting point.
