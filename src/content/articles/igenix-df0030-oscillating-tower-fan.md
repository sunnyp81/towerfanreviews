---
kind: review
title: "Igenix DF0030 Oscillating Tower Fan Review 2026"
description: "We review the Igenix DF0030, one of the cheapest oscillating tower fans available in the UK. Find out how it performs and whether it is worth buying."
h1: "Igenix DF0030 Oscillating Tower Fan Review"
heroEyebrow: "Budget tower fan review"
productSlug: igenix-df0030-oscillating-tower-fan
updatedDate: 2026-06-21
featured: false
faqs:
  - q: "Is the Igenix DF0030 good value for money?"
    a: "Yes, for the price it is a fair buy. The DF0030 offers oscillation and three speed settings at one of the lowest price points available for a named-brand tower fan. It is best suited to personal use in small rooms, not serious cooling in large spaces, but at around £35 the expectations are appropriately modest."
  - q: "How tall is the Igenix DF0030?"
    a: "The DF0030 stands at around 78 cm, which is slightly shorter than many tower fans. This makes it well suited to desk-height use or placing on a low surface, but it may not project airflow as effectively across a room as a taller model standing on the floor."
  - q: "Does the Igenix DF0030 oscillate?"
    a: "Yes. Oscillation is one of the DF0030's key features at this price point. You can toggle it on or off depending on whether you want the airflow directed at you or spread more broadly across the room."
  - q: "What is the difference between the Igenix DF0030 and the Netta tower fan?"
    a: "Both are budget oscillating tower fans at a similar price and with a comparable feature set of three speeds and oscillation. The DF0030 is slightly shorter and has a slimmer profile, while the Netta is marginally lighter. Neither includes a remote or timer. The choice between them largely comes down to availability and aesthetics."
relatedSlugs:
...
The DF0030 is a slim and relatively short tower fan at around 78 cm, which means it is compact enough to sit on a desk or a windowsill rather than strictly requiring a floor position. The slim profile is one of its practical advantages, taking up very little space in a small room or alongside other furniture.
...
Three speeds and oscillation are the complete feature list. There is no remote, no timer, no sleep mode, no ioniser and no display. This is intentional for a fan at this price and aimed at buyers who simply want air movement without any complexity.

If you find yourself wanting a timer to switch the fan off overnight, or a remote so you can adjust it from across the room, either of those additions will push you into the next price bracket. The [Honeywell HO-5500RE](/honeywell-ho-5500re-oscillating/) is worth considering if that is the direction you want to go.

## Is the Igenix DF0030 worth it?
